...
(function($){
    $.fn.smartCart = function(options) {
        ...
        return this.each(function() {
                ...
                // Labels & Messages              
                var labelCartMenuName = 'Mi Pedido (_COUNT_)';  // _COUNT_ will be replaced with cart count
                var labelCartMenuNameTooltip = "Carrito | Productos Totales: _PRODUCTCOUNT_ | Total Quantity: _ITEMCOUNT_";
                var labelProductMenuName = 'Pizzas';
                var labelSearchButton = "Buscar";
                var labelSearchText = "Buscar";
                var labelCategoryText = "Tamaño";
                var labelClearButton = "Limpiar";
                var labelAddToCartButton = "Añadir al Carro"; 
                var labelQuantityText = "Cantidad";
                var labelProducts = 'Pizzas';
                var labelPrice = 'Precio';
                var labelSubtotal = 'Subtotal';
                var labelTotal = 'Total';
                var labelRemove = 'Eliminar';
                var labelCheckout = 'Comprar';
                
                var messageConfirmRemove = 'Desea eliminar "_PRODUCTNAME_" de su pedido?'; //  _PRODUCTNAME_ will be replaced with actula product name
                var messageCartEmpty = "Su pedido está vacío";
                var messageProductEmpty = "No hay pizzas para mostrar";
                var messageProductAddError = "La pizza no se puede adicionar";
                var messageItemAdded = 'Pizza adicionada a su pedido';
                var messageItemRemoved = 'Pizza eliminada de su pedido';
                var messageQuantityUpdated = 'Cantidad de Pizza actualizada';
                var messageQuantityErrorAdd = 'Cantidad invalida. La pizza no se puede adicionar';
                var messageQuantityErrorUpdate = 'Cantidad invalida. Cantidad no se puede actualizar';
                ...
                if(options.enableSearch){
                  var btSearch = $('<a>'+labelSearchButton+'</a>').attr("href","#").addClass("scSearch").attr("title","Search Pizza");                
    ...
    $.fn.smartCart.defaults = {
          ...
          productItemTemplate:'<strong><%=pname%></strong><br />Size: <%=pcategory%><br /><small><%=pdesc%></small><br /><strong>Price: $<%=pprice%></strong>',
